...
public class CreateContact {
	public static void main(String[] args) {
	 ...
	 driver.findElement(By.id("lastNameField")).sendKeys("Vignesh");
	 ...
	 driver.findElement(By.id("createContactForm_departmentName")).sendKeys("BE");
	 driver.findElement(By.id("createContactForm_description")).sendKeys("software tester");
	 driver.findElement(By.id("createContactForm_primaryEmail")).sendKeys("sakthi24@gmail.com");
